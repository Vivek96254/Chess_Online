...
const PIECE_PATHS: Record<PieceType, string> = {
  k: `M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18 M 24,0 L 24,8 M 20,4 L 28,4 M 22.5,9.5 L 22.5,9.5 M 19,21 L 29,21 M 19,18 L 29,18 M 24,0 L 24,8 M 20,4 L 28,4`,
  q: `M 9 13 A 2 2 0 1 1 5 13 A 2 2 0 1 1 9 13 z M 43 13 A 2 2 0 1 1 39 13 A 2 2 0 1 1 43 13 z M 26 13 A 2 2 0 1 1 22 13 A 2 2 0 1 1 26 13 z M 17.5 16.5 A 1.5 1.5 0 1 1 14.5 16.5 A 1.5 1.5 0 1 1 17.5 16.5 z M 33.5 16.5 A 1.5 1.5 0 1 1 30.5 16.5 A 1.5 1.5 0 1 1 33.5 16.5 z M 9 26 C 17.5 24.5 30 24.5 39 26 L 38.5 13.5 L 31 25 L 30.7 10.9 L 25.5 24.5 L 22.5 10 L 19.5 24.5 L 14.3 10.9 L 14 25 L 6.5 13.5 L 6 26 z M 9 26 C 9 28 10.5 28 11.5 30 C 12.5 31.5 12.5 31 12 33.5 C 10.5 34.5 11 36 11 36 C 9.5 37.5 11 38.5 11 38.5 C 17.5 39.5 27.5 39.5 37 38.5 C 37 38.5 38.5 37.5 37 36 C 37 36 37.5 34.5 36 33.5 C 35.5 31 35.5 31.5 36.5 30 C 37.5 28 39 28 39 26 C 27.5 24.5 17.5 24.5 9 26 z`,
  ...
  p: `M 22.5,9 C 19.79,9 17.5,11.29 17.5,14 C 17.5,16.71 19.79,19 22.5,19 C 25.21,19 27.5,16.71 27.5,14 C 27.5,11.29 25.21,9 22.5,9 z M 22.5,25.5 C 18.5,25.5 15,29.5 15,33 C 15,36.5 18.5,39.5 22.5,39.5 C 26.5,39.5 30,36.5 30,33 C 30,29.5 26.5,25.5 22.5,25.5 z M 22.5,19 C 20,19 18,21 18,24 L 27,24 C 27,21 25,19 22.5,19 z`
};
